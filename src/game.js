...
gm.start = function() {
	...
	gm.sq.add({ fn: () => {
		...
		gm.scenes.instWeb.setup(gm.sfx);
	...
	gm.sq.add({ fn: () => {
		...
		gm.scenes.pattern = pattern(gm, gm.sfx);
	...
	gm.sq.add({ fn: () => {
		...
		else gm.scenes.instPattern.setup(gm.sfx);
	...
	gm.sq.add({ fn: () => {
		...
		// 	return gm.sq.next();
		// }
		gm.scenes.walkLevel = walkLevel(gm, player, gm.sfx);
	...
	// rock level
	gm.sq.add({ fn: () => {
		gm.scenes.rockLevel = rockLevel(gm, player, gm.sfx);
